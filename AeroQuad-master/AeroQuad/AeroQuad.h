...
//global variables for control by serial/usb
byte armMotorSerial = OFF;
byte zeroSensorSerial = OFF;
byte altitudeHoldSerial = OFF;
byte flightModeSerial = OFF;
byte enableSerialControl = OFF;
